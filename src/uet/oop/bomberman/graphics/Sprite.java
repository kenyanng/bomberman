...
public class Sprite {
	...
	// Ponta
	public static Sprite Ponta_dead =  new Sprite(16, 12, 8, SpriteSheet.tiles, 16, 16);
	public static Sprite Ponta_left1 = new Sprite(16, 12, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite Ponta_left2 = new Sprite(16, 12, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite Ponta_left3 = new Sprite(16, 12, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite Ponta_right1 = new Sprite(16, 13, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite Ponta_right2 = new Sprite(16, 13, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite Ponta_right3 = new Sprite(16, 13, 7, SpriteSheet.tiles, 16, 16);
	...
	public static Sprite powerup_brickpass = new Sprite(16, 3, 10, SpriteSheet.tiles, 16, 16);
