...
public class Board implements IRender {
	...
	public void render(Screen screen) {
		...
		//chỉ hiển thị phần hiển thị của màn hình
		int x0 = Screen.xOffset >> 4; //độ chính xác của ô, -> trái X
	...
	public void loadLevel(int level) {
		...
		try {
			...
			Sound.getInstance().getAudio(Sound.startStage).play();
	...
	public void endGame() {
		// TODO: Ghi ra file diêm cao nhất
		Integer highScore = Integer.valueOf(Score.Read());
		if ( this.getPoints() > highScore ){
			Score.write(this.getPoints());
		}
		//TODO: show mà hình endgame
		_screenToShow = 1;
		_game.resetScreenDelay();
		_game.pause();
	}
    ...
    // Bo sung phuong thuc getCharactor
	...
	//Bo sung phuong thuc isItemUsed
	...
	public String getHighScores() {
		return String.valueOf(_highScore);
	}
}
